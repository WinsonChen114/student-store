...
export default function Sidebar({ allProducts, isOpen, shoppingCart, products, checkoutForm, handleOnCheckoutFormChange, handleOnSubmitCheckoutForm, handleOnToggle, error, setError, receipt}) {
  return (
